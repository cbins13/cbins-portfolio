...
const Home = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen max-w-5xl mx-auto flex items-center justify-center relative"
    >
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r bg-clip-text from-blue-500 to-cyan-400 leading-right text-transparent">
            Hi, I'm Christian
          </h1>
          ...
          <p className="text-gray-400 text-lg mb-6 max-w-lg mx-auto">
            I'm a full-stack web developer with a passion for solving business
            problems with code and collaboration between the team and the
            client. Specialization includes web development in ReactJS, NodeJS,
            OracleSQL, MySQL, and MongoDB.
          </p>
