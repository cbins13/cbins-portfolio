            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <RevealOnScroll delay={0.1}>
                <HoverCard scale={1.05}>
                  <a
                    href={mailtoLink}
                    className="group p-6 rounded-xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all text-center cursor-pointer block"
                  >
              ...
              <RevealOnScroll delay={0.2}>
                <HoverCard scale={1.05}>
                  <a
                    ...
                    className="group p-6 rounded-xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all text-center block"
                  >
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/30 flex items-center justify-center group-hover:border-blue-500/60 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all">
                <svg
                  className="w-8 h-8 text-blue-400 group-hover:text-blue-300 transition-colors"
              ...
              <RevealOnScroll delay={0.3}>
                <HoverCard scale={1.05}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-6 rounded-xl border border-white/10 bg-gradient-to-br from-violet-500/10 to-fuchsia-600/10 hover:border-violet-500/30 hover:shadow-[0_2px_8px_rgba(139,92,246,0.2)] transition-all text-center block"
                  >
